	...
	<div class="nav-info">
		<div class="nav">
			<div class="left-nav">
				<div role="button" title="QKYG Games" class="logo-box" id="logoBox">
					<div class="logo-box-box">
						<div class="QKYG-logo white" onclick="location.href='QkHome.jsp'" aria-label="QKYG Games"></div>
					</div>
				</div>
				...
				<div class="nav-links">
					...
					<div class="nav-item">
						<div class="nav-item-box">
							<div class="nav-item-links">
								<a href="Controller?command=community" class="nav-item-links nav-txt-links" tabindex="-1">커뮤니티</a>
							</div>
						</div>
					</div>
					<div class="nav-item">
			...
			<div id="rightNav" class="right-nav-full">
				...
				%>
					...
					<div class="dropdown">
						...
						<ul role="menu">
							...
							<li>
								<a class="text-color-nonactive" href="profileSetting.jsp" role="menuitem" id="dropdown-link-accountInfo" data-index="4">
									<span>계정</span>
								</a>
							</li>
							<li>
				...
				<script defer src="js/NavFriend.js"></script>
				<a class="nav-item-pc" tabindex="0" href="<%if(userType==2){out.print("Controller?command=payment");} else{out.print("Controller?command=pcCafe");}%>">
