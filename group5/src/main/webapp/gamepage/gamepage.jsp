    ...
    <script>
        ...
        var mediaPaths = [
            ...
            try {
                ...
                Connection connection = DriverManager.getConnection("jdbc:oracle:thin:@210.114.1.134:1521:xe", "temp", "1234");
...
<%
		...
		try {
			...
			String sql6="SELECT TO_CHAR(release_date, 'YYYY-MM-DD') AS formatted_date, m.graphic,r.graphic graphic_1,p.platform,ori_prc,m.os,r.os os_1,m.process,r.process process_1,\r\n"
					...
					+ "m.g_no='1011'";
			Connection conn5 = DriverManager.getConnection("jdbc:oracle:thin:@210.114.1.134:1521:xe", "temp", "1234");
