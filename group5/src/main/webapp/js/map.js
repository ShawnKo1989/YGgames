...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
	mapOption = {
		center: new kakao.maps.LatLng(37.55416128367601, 126.93554060931733), // 지도의 중심좌표
...
geocoder.addressSearch('서울 마포구 서강로 136', function(result, status) {
	...
	if (status === kakao.maps.services.Status.OK) {
		...
		// 툴팁을 노출하는 마커를 생성합니다.
		var marker1 = new TooltipMarker(coords, 'QKYG게임즈');
		//		marker1.setMap(map);
		...
		var infowindow = new kakao.maps.InfoWindow({
			content: `<div style="width:150px;text-align:center;padding:6px 0;">QKYG게임즈</div>
			<a href="https://map.kakao.com/link/map/QKYG게임즈,37.55416128367601, 126.93554060931733" style="color:blue" target="_blank">큰지도보기</a>
			<a href="https://map.kakao.com/link/to/QKYG게임즈,37.55416128367601, 126.93554060931733" style="color:blue" target="_blank">길찾기</a></div>` // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
