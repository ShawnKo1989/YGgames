...
<head>
    <meta charset="UTF-8">
    <title>새 소식</title>
    <link rel="stylesheet" href="/group5/css/NewsMain.css" />
...
<body>
    ...
    <main>
        ...
        <div class="newsMain">
            <div class="newsLeft">
                <a href="/group5/Controller?command=newsIn&newsNo=<%= newsList.get(9).getNewsNo() %>">
                ...
                <a class="see" href="/group5/Controller?command=newsIn&newsNo=<%= newsList.get(9).getNewsNo() %>">
                    <br/>
                    <br/>
                    <br/>
            ...
            <div class="newsRight">
                <a href="/group5/Controller?command=newsIn&newsNo=<%= newsList.get(8).getNewsNo() %>">
                    <div class="newsMainImg">
                ...
                <a class="see" href="/group5/Controller?command=newsIn&newsNo=<%= newsList.get(8).getNewsNo() %>">
                    <br/>
                    <br/>
                    <br/>
                    <span class="See">자세히보기</span>
