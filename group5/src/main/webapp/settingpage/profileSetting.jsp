...
<%
	...
	String mobileOTPNum = (String)request.getAttribute("mobileOTPNum");
	String userPhoneNum = (String)request.getAttribute("userPhoneNum");
%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<link href="/group5/css/profileSetting.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet"
	href="//code.jquery.com/ui/1.13.2/themes/base/jquery-ui.css">
<link rel="stylesheet" href="/resources/demos/style.css">
<link rel="stylesheet" href="css/lookforward.min.css" />
<script src="/group5/js/lookforward.js"></script>
<script src="/group5/js/jquery-3.7.0.min.js"></script>
<script defer src="/group5/js/jquery-lookforward.min.js"></script>
<script defer src="/group5/js/lookforward.js"></script>
...
<body>
	...
	<div style="display: flex;">
		<div id="settingList">
			<button name="setting" id="accSetting" class="list_btn">
				<img src="/group5/images/setting.png"><span>&nbsp계정설정</span>
			</button>
			<button id="pwChange" name="pwchange" class="list_btn">
				<img src="/group5/images/pwchange.png"><span>&nbsp비밀번호 변경</span>
			</button>
			<button id="gameMoney" name="gamemoney" class="list_btn">
				<img src="/group5/images/gamemoney.png"><span>&nbsp회원탈퇴</span>
			</button>
		...
		<div class="pop_inner2">
			...
			<div class="pop_input_area">
				...
				<p style="float: left; margin-top: 26px; margin-left: 14px;">+82
					:</p>
				<input type="number" id="user_phone_num" name="userPhoneNum" required /><label
	...
	<div id="mobile_otp_pop" class="pop_wrap2" style="display: none;">
		<div class="pop_inner3">
			...
			<input type="hidden" name="mobileOTPNum" value="<%= mobileOTPNum%>">
	...
	<script>
		...
		$(function() { // 페이지 로드함수로 구현
			$("#accSetting").on("click", function() {
				$("#here").load("/group5/settingpage/profileSetting.jsp #changedbody");
			});
			$("#pwChange").on("click", function() {
				$("#here").load("/group5/settingpage/changepw.jsp #changedbody");
			});
			$("#gameMoney").on("click", function() {
				$("#here").load("/group5/settingpage/withdrawal.jsp #changedbody");
			});
			// 패쓰워드 이미지가 보였다 안보였다 하는 기능
			$(document).on('click', '#show_btn1', function() {
				$('#show_btn1').toggleClass('active');
				if ($('#show_btn1').hasClass('active')) {
					$(this).attr('src', "/group5/images/showpw2.png");
					$('#pwinput1').attr('type', "text");
				} else {
					$(this).attr('src', "/group5/images/showpw.png");
