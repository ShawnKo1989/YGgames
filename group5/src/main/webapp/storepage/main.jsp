...
<link href="/group5/css/storemain.css" rel="stylesheet" type="text/css" />
...
%>
	...
	$(document).on('click', 'img', function(){
		location.href="/group5/gamepage/gamepage.jsp";
	});
</script>
</HEAD>
...
<body>
	...
	<div class="main">
		...
		: Integer.parseInt((dpList.get(i).getOri_prc()).replaceAll("[,]","")) <0 ? "출시예정작" : "무료게임" %>
			...
			<div id="progressbar1" class="flow_game_outter" style="background: transparent; width: 265px; height: 115px; border: 0;">
			...
			<div id="progressbar2" class="flow_game_outter"style="background: transparent; width: 265px; height: 115px;border: 0;">
				<div class="progress-label">
					<div class="flow-game">
						<div id="flow_img">
			...
			<div id="progressbar3" class="flow_game_outter"style="background: transparent; width: 265px; height: 115px;border: 0;">
				<div class="progress-label">
					<div class="flow-game">
						<div id="flow_img">
			...
			<div id="progressbar4" class="flow_game_outter"style="background: transparent; width: 265px; height: 115px;border: 0;">
				<div class="progress-label">
					<div class="flow-game">
						<div id="flow_img">
			...
			<div id="progressbar5" class="flow_game_outter"style="background: transparent; width: 265px; height: 115px;border: 0;">
				<div class="progress-label">
					<div class="flow-game">
						<div id="flow_img">
